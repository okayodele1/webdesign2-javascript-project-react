 ...
 const Home = () => {
  ...
  <div id="slider" class="slider">
   ...
   <p> We invite you to connect with us, whether to learn more about our ongoing initiatives, express your interest in volunteering, or inquire about partnership opportunities. Your involvement, support, and ideas are invaluable in furthering our mission and creating lasting change in the world</p>
    <a href="/donate"><button> Donate Now </button></a></div>
    </div>
    </div>
  <div class="sections">
...
<div class="sec2-div" ><img src={green}  className="green"/></div>
...
<div  class="activity" style={{backgroundImage:`url(${img1})`}}><h2>Child's Education Support</h2> </div>
<div  class="activity" style={{backgroundImage:`url(${img2})`}}><h2>Ophans Upbringing </h2></div>
<div  class="activity" style={{backgroundImage:`url(${img3})`}}><h2>Widows Support Programmes</h2> </div>
...
<center> <button> Find an item </button></center>
     ...
     <div class="sections">
        ...
        the needy for a better future transition.
